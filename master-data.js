...
const MASTER_DATA = {
  profile: [
    { profile: "#90S",  min: 210,  max: 360,  h: 9,    w: 90 // スプレッドシートのマスタタブ(マスタ / 裏込材マスタ / 品質管理マスタ / 座屈限界圧マスタ)を
// そのままJSONに書き出したものです。
// マスタの数値を修正したいときは、このファイルの該当箇所だけを書き換えてください。
// (元のスプレッドシートを直した後、この形式に合わせて書き写す運用を想定しています)
...
const MASTER_DATA = {
  profile: [
    { profile: "#90S",  min: 210,  max: 360,  h: 9,    w: 90, t: 1.6 },
    { profile: "#87S",  min: 370,  max: 550,  h: 11.9, w: 87, t: 1.8 },
    { profile: "#80S",  min: 560,  max: 850,  h: 16.3, w: 80, t: 2.6 },
    { profile: "#79S",  min: 860,  max: 1360, h: 21.5, w: 79, t: 3.4 },
    { profile: "#79SW", min: 1361, max: 2130, h: 21.5, w: 79, t: 3.4 }
  ],
